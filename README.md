...
local ThunderImageUI = Instance.new("ImageLabel")
       ...
       _G.Color = Color3.fromRGB(209, 76, 255)
        end 
        end
...
local Library = win:Server("SUNFLEX HUB","")
local Main = Library:Channel("Main","rbxassetid://6026568198")
local M = Library:Channel("Weapons","rbxassetid://11162889532")
local Ss = Library:Channel("Stats","rbxassetid://11155953071")
local P = Library:Channel("Player","rbxassetid://7251993295")
local R = Library:Channel("Raid","rbxassetid://11155986081")
local T = Library:Channel("Teleport","rbxassetid://11155851001")
local S = Library:Channel("Shop","rbxassetid://6031265976")
local D = Library:Channel("Fruit","rbxassetid://11156000139")
local Misc = Library:Channel("Miscellaneous","rbxassetid://11156061121")
local Esp = Library:Channel("ESP","rbxassetid://9608089732")


Main:Label("Welcome To SUNFLEX HUB BF Mobile/Pc")
